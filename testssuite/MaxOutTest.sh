...
python3 $pdnndir/cmds/run_DNN.py --train-data "train.part*.blp" \
                                ...
                                --activation "maxout:3" --param-output-file dnn.param --cfg-output-file dnn.cfg  >> nn.log 2>&1
...
echo "MaxOut Dropout Adaptive Learning Rate Test" >> testing.log
