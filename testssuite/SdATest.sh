...
python3 $pdnndir/cmds/run_DNN.py --train-data "train.part*.blp" \
                                ...
                                --ptr-file dnn.pre --ptr-layer-number -1 --activation tanh \
...
echo "Pretrained Adaptive Learning Rate Test" >> testing.log
